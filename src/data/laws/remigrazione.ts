...
export const remigrazione: Legge = {
  ...
  regole: [
    ...
    },
    {
      ...
      campiNecessari: ['cittadinanza', 'permessoSoggiorno'],
      condizioni: [
        { campo: 'cittadinanza', op: 'eq', valore: 'extra-ue' },
        { campo: 'permessoSoggiorno', op: 'in', valore: ['si', 'preferisco-non-dirlo'] }
      ],
      effetto: {
        tipo: 'servizio',
      ...
      timeline: { anno1: 'incerto', anno2: 'incerto', anno5: 'incerto', anno10: 'incerto' },
      confidenza: 'dipende',
      noteConfidenza: 'L\'adesione sarebbe volontaria e aperta agli extracomunitari regolari da almeno 12 mesi, ai richiedenti asilo che rinunciano alla domanda e ai titolari di permessi in scadenza: per questo riguarda chi ha (o ha avuto) un permesso, non chi è già senza. La proposta deve ancora essere votata.',
      fonteRegola: FONTE
    },
    {
      id: 'remigrazione-irregolari',
      campiNecessari: ['cittadinanza', 'permessoSoggiorno'],
      condizioni: [
        { campo: 'cittadinanza', op: 'eq', valore: 'extra-ue' },
      ...
      timeline: { anno1: 'incerto', anno2: 'incerto', anno5: 'incerto', anno10: 'incerto' },
      confidenza: 'dipende',
      noteConfidenza: 'Vale per chi ha dichiarato di non avere un permesso valido. È una proposta non ancora discussa né votata; i rimpatri restano comunque vincolati al rispetto degli obblighi internazionali (divieto di respingimento verso Paesi non sicuri).',
      fonteRegola: FONTE
    },
    {
